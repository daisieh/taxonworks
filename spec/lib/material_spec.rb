...
describe 'Material' do
  ...
  context '#create_quick_verbatim' do
    ...
    specify 'biocuration_classifications are built' do
      @two_objects_stub['collection_objects']['object1']['total']               = 1
      @two_objects_stub['collection_objects']['object1']['biocuration_classes'] = {@attribute1.id.to_s => '1',
                                                                                   @attribute2.id.to_s => '1',
                                                                                   @attribute3.id.to_s => '1',
                                                                                   @attribute4.id.to_s => '1'}
      @two_objects_stub['collection_objects']['object2']['total']               = 5
      @two_objects_stub['collection_objects']['object2']['biocuration_classes'] = {@attribute1.id.to_s => '1',
                                                                                   @attribute4.id.to_s => '1'}
