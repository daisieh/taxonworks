  ...
  context 'geolocate responses from geographic_area' do
    ...
    context 'geolocate_ui_param' do
      ...
      specify 'retrieving geolocate UI paramerters as a hash' do
        ...
        expect(@geographic_area.geolocate_ui_params).to eq({'country'       => 'United States of America',
                                                            'state'         => 'Illinois',
                                                            'county'        => 'Champaign',
                                                            'locality'      => nil,
        ...
        expect(@geographic_area.parent.geolocate_ui_params).to eq({'country'       => 'United States of America',
                                                                   'state'         => 'Illinois',
                                                                   'county'        => nil,
                                                                   'locality'      => nil,
        ...
        expect(@geographic_area.parent.parent.geolocate_ui_params).to eq({'country'       => 'United States of America',
                                                                          'state'         => nil,
                                                                          'county'        => nil,
                                                                          'locality'      => nil,
                                                                          'Latitude'      => nil,
        ...
        expect(@geographic_area.parent.parent.parent.geolocate_ui_params).to eq({'country'       => nil,
                                                                                 'state'         => nil,
                                                                                 'county'        => nil,
                                                                                 'locality'      => nil,
                                                                                 'Latitude'      => nil,
        ...
        expect(@ford_county.geolocate_ui_params).to eq({'country'       => 'United States of America',
                                                        'state'         => 'Illinois',
                                                        'county'        => 'Ford',
                                                        'locality'      => nil,
                                                        'Latitude'      => 40.1211151426486,
