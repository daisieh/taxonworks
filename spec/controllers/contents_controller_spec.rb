...
describe ContentsController, :type => :controller do
  ...
  describe "GET show" do
    it "assigns the requested content as @content" do
      content = Content.create! valid_attributes
      get :show, params: {:id => content.id.to_s}, session: valid_session
  ...
  describe "GET edit" do
    it "assigns the requested content as @content" do
      content = Content.create! valid_attributes
      get :edit, params: {:id => content.id.to_s}, session: valid_session
      expect(assigns(:content)).to eq(content)
    end
  end
  ...
  describe 'PUT update' do
    describe 'with valid params' do
      ...
      it 'updates the requested content' do
        ...
        put :update, params: {:id => content.id.to_s, :content => {:text => 'params'}}, session: valid_session
      end

      it "assigns the requested content as @content" do
        content = Content.create! valid_attributes
        put :update, params: {:id => content.id.to_s, :content => valid_attributes}, session: valid_session
        expect(assigns(:content)).to eq(content)
      end
    ...
    describe "with invalid params" do
      it "assigns the content as @content" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Content).to receive(:save).and_return(false)
        put :update, params: {:id => content.id.to_s, :content => {:invalid => 'parms'}}, session: valid_session
        expect(assigns(:content)).to eq(content)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested content" do
      content = Content.create! valid_attributes
      expect {
        delete :destroy, params: {:id => content.id.to_s}, session: valid_session
      }.to change(Content, :count).by(-1)
    end
