...
describe LoansController, :type => :controller do
  ...
  let(:valid_attributes) { strip_housekeeping_attributes(FactoryGirl.build(:valid_loan).attributes) }
  ...
  describe "GET show" do
    it "assigns the requested loan as @loan" do
      loan = Loan.create! valid_attributes
      get :show, params: {:id => loan.id.to_s}, session: valid_session
  ...
  describe "GET edit" do
    it "assigns the requested loan as @loan" do
      loan = Loan.create! valid_attributes
      get :edit, params: {:id => loan.id.to_s}, session: valid_session
      expect(assigns(:loan)).to eq(loan)
    end
  end
  ...
  describe 'PUT update' do
    describe 'with valid params' do
      ...
      it 'updates the requested loan' do
        ...
        put :update, params: {:id => loan.id.to_s, :loan => {:supervisor_email => 'ugly'}}, session: valid_session
      end

      it 'assigns the requested loan as @loan' do
        loan = Loan.create! valid_attributes
        put :update, params: {:id => loan.id.to_s, :loan => valid_attributes}, session: valid_session
        expect(assigns(:loan)).to eq(loan)
      end
    ...
    describe "with invalid params" do
      it "assigns the loan as @loan" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Loan).to receive(:save).and_return(false)
        put :update, params: {:id => loan.id.to_s, :loan => {:invalid => 'parms'}}, session: valid_session
        expect(assigns(:loan)).to eq(loan)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested loan" do
      loan = Loan.create! valid_attributes
      expect {
        delete :destroy, params: {:id => loan.id.to_s}, session: valid_session
      }.to change(Loan, :count).by(-1)
    end
