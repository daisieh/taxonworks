...
describe RepositoriesController, :type => :controller do
  ...
  describe "GET show" do
    it "assigns the requested repository as @repository" do
      repository = Repository.create! valid_attributes
      get :show, params: {:id => repository.id.to_s}, session: valid_session
  ...
  describe "GET edit" do
    it "assigns the requested repository as @repository" do
      repository = Repository.create! valid_attributes
      get :edit, params: {:id => repository.id.to_s}, session: valid_session
      expect(assigns(:repository)).to eq(repository)
    end
  end
  ...
  describe 'PUT update' do
    describe 'with valid params' do
      ...
      it 'updates the requested repository' do
        ...
        put :update, params: {:id => repository.id.to_s, :repository => {'name' => 'MyString'}}, session: valid_session
      end

      it 'assigns the requested repository as @repository' do
        repository = Repository.create! valid_attributes
        put :update, params: {:id => repository.id.to_s, :repository => valid_attributes}, session: valid_session
        expect(assigns(:repository)).to eq(repository)
      end
    ...
    describe "with invalid params" do
      it "assigns the repository as @repository" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Repository).to receive(:save).and_return(false)
        put :update, params: {:id => repository.id.to_s, :repository => {"name" => "invalid value"}}, session: valid_session
        expect(assigns(:repository)).to eq(repository)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested repository" do
      repository = Repository.create! valid_attributes
      expect {
        delete :destroy, params: {:id => repository.id.to_s}, session: valid_session
      }.to change(Repository, :count).by(-1)
    end
