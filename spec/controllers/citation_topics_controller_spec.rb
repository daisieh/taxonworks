...
describe CitationTopicsController, :type => :controller do
  ...
  let(:valid_attributes) { strip_housekeeping_attributes(FactoryGirl.build(:valid_citation_topic).attributes) }
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new CitationTopic" do
        expect {
          post :create, params: {:citation_topic => valid_attributes}, session: valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved citation_topic as @citation_topic" do
        ...
        post :create, params: {:citation_topic => {bar: 'Foo'}}, session: valid_session
