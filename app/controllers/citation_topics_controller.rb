class CitationTopicsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @citation_topic.save
        format.html { redirect_back fallback_location: hub_url, notice: 'Citation topic was successfully created.' }
        format.json { render json: @citation_topic, status: :created, location: @citation_topic }
      else
        format.html { redirect_back fallback_location: hub_url, notice: 'Citation topic was NOT successfully created.' }
  ...
  def update
    respond_to do |format|
      if @citation_topic.update(citation_topic_params)
        format.html { redirect_back fallback_location: hub_url, notice: 'Citation topic was successfully updated.' }
        format.json { render json: @citation_topic, status: :ok, location: @citation_topic }
      else
        format.html { redirect_back fallback_location: hub_url, notice: 'Citation topic was NOT successfully updated.' }
        format.json { render json: @citation_topic.errors, status: :unprocessable_entity }
      end
    end
  end
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_back fallback_location: hub_url, notice: 'Citation topic was successfully destroyed.' }
