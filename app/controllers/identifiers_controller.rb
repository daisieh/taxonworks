class IdentifiersController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @identifier.update(identifier_params)
        ...
        format.html { redirect_back fallback_location: hub_url, notice: 'Identifier was NOT successfully updated.' }
        format.json { render json: @identifier.errors, status: :unprocessable_entity }
      end
    end
  end
  ...
  def destroy
    @identifier.destroy
    respond_to do |format|
      format.html { redirect_back fallback_location: hub_url, notice: 'Identifier was successfully destroyed.' }
      format.json { head :no_content }
    end
  end
