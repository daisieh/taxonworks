class OtuPageLayoutSectionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @otu_page_layout_section.save
        format.html { redirect_back fallback_location: hub_url, notice: 'Otu page layout section was successfully created.' }
        format.json { render json: @otu_page_layout_section, status: :created, location: @otu_page_layout_section }
      else
        format.html { redirect_back fallback_location: hub_url, notice: 'Otu page layout section was NOT successfully created.' }
  ...
  def update
    respond_to do |format|
      if @otu_page_layout_section.update(otu_page_layout_section_params)
        format.html { redirect_back fallback_location: hub_url, notice: 'Otu page layout section was successfully updated.' }
        format.json { render json @otu_page_layout_section, status: :ok, location: @otu_page_layout_section }
      else
        format.html { redirect_back fallback_location: hub_url, notice: 'Otu page layout section was NOT successfully updated.' }
        format.json { render json: @otu_page_layout_section.errors, status: :unprocessable_entity }
      end
    end
  end
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_back fallback_location: hub_url, notice: 'Otu page layout section was successfully destroyed.' }
  ...
  def set_otu_page_layout_section
    @otu_page_layout_section = OtuPageLayoutSection.with_project_id($project_id).find(params[:id])
  end
