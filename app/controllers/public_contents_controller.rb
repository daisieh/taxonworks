class PublicContentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @public_content.save
        format.html { redirect_back fallback_location: hub_url, notice: 'Public content was successfully created.' }
        format.json { render json: @public_content, status: :created, location: @public_content }
      else
        format.html { redirect_back fallback_location: hub_url, notice: 'Public content was NOT successfully created.' }
  ...
  def update
    respond_to do |format|
      if @public_content.update(public_content_params)
        format.html { redirect_back fallback_location: hub_url, notice: 'Public content was successfully updated.' }
        format.json { render @public_content, status: :ok, location: @public_content }
      else
        format.html { redirect_back fallback_location: hub_url, notice: 'Public content was NOT successfully updated.' }
        format.json { render json: @public_content.errors, status: :unprocessable_entity }
      end
    end
  end
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_back fallback_location: hub_url, notice: 'Public content was successfully destroyed.' }
