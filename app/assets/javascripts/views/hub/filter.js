...
function initDataCardsPage() {
  ...
  var 
  core = new CarrouselData("Core",99,0),	
  supporting = new CarrouselData("Supporting",99,0),	
  annotations = new CarrouselData("Annotations",99,0);
